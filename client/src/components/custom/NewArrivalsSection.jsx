...
const NewArrivalsSection = () => {
    ...
    return (
      <div className="max-w-[1800px] mx-auto px-3 sm:px-4 lg:px-6 py-6 md:py-8 lg:py-12">
        <div className="flex justify-center py-8 md:py-10">
          <OneLoader size="medium" text="Loading new arrivals..." />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-[1800px] mx-auto px-3 sm:px-4 lg:px-6 pt-2 sm:pt-5 pb-6 md:py-8 lg:py-12">
