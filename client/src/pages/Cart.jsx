...
const Cart = () => {
  ...
  return (
    <>
      <SEO
        title="Shopping Cart"
        description="Review the items saved in your HELLAS shopping bag, update quantities, and move securely to checkout."
        keywords={["HELLAS cart", "shopping bag", "review order"]}
        noIndex
      />
