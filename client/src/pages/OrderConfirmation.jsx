...
const OrderConfirmation = () => {
  ...
  const seoElement = (
    <SEO
      ...
      description="View your HELLAS order confirmation, key delivery information, and recommended next steps."
      keywords={["order confirmation", "HELLAS order", "delivery status"]}
      noIndex
    />
  );
